'''
Desafio 3
Basado en un archivo de texto, realize las siquientes busquedas para encontrar dos numeros (int)
Buscar a la derecha, izquierda de n palabra.
Buscar en el inicio, centro, extremos, final de una linea de texto.
Al encontrarlos, realizar operaciones basados en las lineas pedidas.
'''
...
def Operacion(primerNumero, operador, segundoNumero): # Realizar la operacion correspondiente
